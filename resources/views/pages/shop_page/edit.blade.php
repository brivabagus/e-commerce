    ...
    <div class="container m-t-59 d-flex justify-content-center">
        <div class="card w-50 ">
            <div class="card-header bg-secondary">
                <p class="text-white">Form to Update Item</p>
                
            </div>
            <div class="card-body">
                <form action="/shop/{{ $item->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="any" class="form-control" id="price" name="price" value="{{ old('price', $item->price) }}"
                            placeholder="Price">
                            @error('price')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="border border-secondary p-2" name="description" id="description" value="{{ old('description', $item->description) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="image" name="image" value="{{ old('image', $item->image) }}">
                        @error('image')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
